...
training_matrices_for_handwriting = training_matrices_for_handwriting + training_matrices_symbols
...
store_matrices_to_file(matrices_for_residual, 'louietrainingimages/louiesymbolresiduals.txt')
