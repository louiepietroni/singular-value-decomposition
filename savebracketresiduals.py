...
seperate_digits = []
files_of_handwriting = ['louietrainingimages/otherdigits.jpg']
...
for index, digit in enumerate(seperate_digits):
    ...
    show_digit(processed_digit, str(index))

    correct_digit = input('what digit' + str(index))

    if correct_digit == ' ':
        continue
    elif correct_digit == '9':
...
store_matrices_to_file(training_matrices_for_handwriting, 'louietrainingimages/bracketdigitmatrices.txt')
